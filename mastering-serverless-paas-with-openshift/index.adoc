...
----
ssh lab-uswe@workstation-<GUID>.rhpds.opentlc.com
----
...
Under the hood OpenShift will create new Pods with the proper runtime to run such functions, with a number proportional to the load required and depending of configuration desired, by default
